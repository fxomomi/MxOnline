...
class EmailVerifyRecord(models.Model):
    ...
    SendType = models.CharField(max_length=10, choices=(("register", u"注册"), ("forget", u"找回密码")))
    SendTime = models.DateTimeField(default=datetime.now) # datetime.now()取的是编译时的时间，不加括号才是实例化时的时间
